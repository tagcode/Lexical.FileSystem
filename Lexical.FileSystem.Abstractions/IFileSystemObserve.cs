...
namespace Lexical.FileSystem
{
    ...
    public interface IFileSystemObserve : IFileSystem, IFileSystemOptionObserve
    {
        ...
        IFileSystemObserver Observe(string filter, IObserver<IFileSystemEvent> observer, object state = null, IFileSystemEventDispatcher eventDispatcher = null, IFileSystemToken option = null);
    }
