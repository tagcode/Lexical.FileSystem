...
namespace Lexical.FileSystem
{
    ...
    public class NoOption : IOption
    {
        /// <summary>No options</summary>
        static IOption instance = new NoOption();
        /// <summary>No options</summary>
        public static IOption Instance => instance;
        /// <inheritdoc/>
    ...
    {
        internal static IOption instance = new ReadOnlyOption();
