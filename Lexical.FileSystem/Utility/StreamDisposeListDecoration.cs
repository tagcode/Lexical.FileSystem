...
{
    /// <summary>
    /// Decoration of <see cref="Stream"/> that also implements <see cref="IDisposeList"/> and <see cref="IBelatableDispose"/>.
    /// </summary>
    public class StreamDisposeListDecoration : StreamDecoration, IDisposeList, IBelatableDispose
    {
        /// <summary>
        ...
        public StreamDisposeListDecoration(Stream sourceStream) : base(sourceStream)
        {
        }
        ...
        {
            StreamDisposeListDecoration parent;
