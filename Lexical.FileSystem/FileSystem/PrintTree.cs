...
namespace Lexical.FileSystem
{
    ...
    public static class PrintTree
    {
        ...
        public static void PrintTo(this IFileSystem filesystem, TextWriter output, string path = "", int depth = Int32.MaxValue, Format format = Format.Default, IOption option = null)
        {
        ...
        /// <param name="format">print format</param>
        /// <param name="option">(null) session or security token</param>
        public static void PrintTo(this IFileSystem filesystem, StringBuilder output, string path = "", int depth = Int32.MaxValue, Format format = Format.Default, IOption option = null)
        {
        ...
        public static String Print(this IFileSystem filesystem, string path = "", int depth = Int32.MaxValue, Format format = Format.Default, IOption option = null)
        {
