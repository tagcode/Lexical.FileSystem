...
namespace Lexical.FileSystem
{
    ...
    /// </summary>
    public abstract class ObserverBase : DisposeList, IFileSystemObserver
    {
        /// <summary>
        ...
        protected ObserverBase(IFileSystem filesystem, string filter, IObserver<IEvent> observer, object state, IEventDispatcher eventDispatcher)
        {
